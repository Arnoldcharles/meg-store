                  ...
                  <div className="bg-gray-50 shadow-md rounded-xl p-6 max-w-md mx-auto flex flex-col items-center">
                    ...
                    <div className="mt-4 w-full flex gap-2">
                      ...
                      <Link
                        ...
                        className="w-1/3 bg-white text-green-600 border border-green-500 py-2 rounded-lg text-center hover:bg-green-50 transition"
                      >
                        View
                      </Link>
                      ...
                      <button
                        ...
                        className="w-1/3 bg-white text-gray-800 border border-gray-300 py-2 rounded-lg text-center hover:bg-gray-50 transition"
                      >
                        Quick View
                      </button>
