...
export const products: Product[] = [
  ...
  },
  {
    ...
    image: "/products/uguleaf.jpg",
    description: "Fresh ugu leaves for seasoning and cooking.",
    price: 300,
    category: "Vegetables",
    stock: 20,
    bestSeller: false,
    createdAt: "2025-10-10T04:50:00Z",
  },
  {
    id: "9128790131",
    name: "Scent Leaf (Efirin)",
    image: "",
    description: "Fresh scent leaf for seasoning and cooking.",
    price: 200,
    category: "Vegetables",
    stock: 20,
    bestSeller: false,
  ...
  {
    id: "10128790132",
    name: "Stockfish Head (Big Size)",
    image: "/products/stockfishheadbig.jpg",
    description: "High-quality stockfish head for your cooking needs.",
    price: 2500,
    category: "Fish",
    stock: 15,
    bestSeller: false,
