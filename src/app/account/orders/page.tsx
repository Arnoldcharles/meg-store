...
export default function OrdersPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      {orders.length === 0 ? (
        <div className="bg-white p-6 rounded shadow text-center">No orders found.</div>
      ) : (
            ...
            <div key={o.id} className="bg-white p-4 rounded shadow flex justify-between items-center">
              ...
              <div className="text-right">
                ...
                <div className="mt-2 flex gap-2">
                  <Link href={`/account/orders/${o.id}`} className="px-3 py-1 bg-blue-600 text-white rounded">View</Link>
                </div>
              </div>
            </div>
          ))}
