    ...
    <div className="min-h-screen bg-gray-50 py-16">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-3 gap-8 items-start">
          <motion.div
            className="lg:col-span-1 bg-white rounded-xl p-6 shadow"
            initial={{ opacity: 0, x: -20 }}
            animate={{ opacity: 1, x: 0 }}
          >
            <h2 className="text-xl font-semibold mb-4">Get in touch</h2>
            <p className="text-gray-600 mb-6">
              Questions, order help, or custom requests — we're here to help.
              Reach out using the form or the channels below.
            </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm">
                    24 Ebinpejo St, Lagos City, Nigeria
                  </div>
                </div>
              </div>
          ...
          <motion.form
            ...
            className="lg:col-span-2 bg-white rounded-xl p-6 shadow space-y-4"
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
          >
            {success && (
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <label className="block">
                ...
                <input
                  ...
                  className="mt-1 w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-indigo-200"
